(function ($) {
    ...
    function createSelectElement(element) {
        ...
        const button = $('<button class="btn form-control text-left" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"/>').addClass(btnClasses);
        const alert = $('<div class="alert alert-danger select-extend-alert" role="alert"/>');
        const dropdown = $('<div class="dropdown-menu form-control"/>').append(alert);
